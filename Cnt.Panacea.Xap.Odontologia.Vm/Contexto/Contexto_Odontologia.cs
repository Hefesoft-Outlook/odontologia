...
//Clase que maneja las llamadas al servicio
        ...
        {
            public static bool guardado_En_Proceso = false;

            private static OdontologiaServicioClient cliente;

            public static dynamic binding;
            ...
            public static Task<bool> ActualizarPlanesTratamiento(TratamientoEntity Tratamiento, PlanesTratamientoCollection Planes)
            {
            ...
            public static Task<bool> Actualizartratamiento(TratamientoEntity Tratamiento)
            {
            ...
            public static Task<ConvenioEntity> consultarConvenio(short id)
            {
                inicializarContexto();
            ...
            /// </summary>
            public static Task<ObservableCollection<TratamientoEntity>> ConsultarTratamientosPaciente(short idIps, int idPaciente)
            {
                inicializarContexto();
            ...
            //public static Task<ObservableCollection<ConfiguracionDiagnosticoOdontologiaEntity>> ConsultarDiagnosticosConfigurados(short idIps)
            //{
            ...
            public static Task<ObservableCollection<ConfiguracionProcedimientoOdontologiaDto>> ConsultarProcedimientosOdontologiaLigero(short idIps)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<TipoTratamientoEntity>> ConsultarTiposTratamiento(short IdIps)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<RelaDiagnosticoProcedEntity>> ConsultarProcedimientosPorDiagnostico(short idIps,String Diagnosticos)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<ProcedimientoEspecialidadSedeEntity>> ConsultarEspecialidadesPorProcedimiento(short idSede, string Procedimientos)
            {
                inicializarContexto();
            ...
            public static Task<TratamientoImagenEntity> ConsultarImagenTratamiento(int idImagenTratamiento)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<NivelSeveridadDXEntity>> ConsultarNivelSeveridad()
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<OdontogramaEntity>> ConsultarOdontogramaPaciente(Int64 idOdontogramaPaciente, short idIps)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>> ConsultarOtrasCaracteristicasConfig(short idIps)
            {
                inicializarContexto();
            ...
            public static Task<TerceroEntity> ConsultarPrestador(int IdPrestador)//LFDO Bug 16006
            {
                inicializarContexto();
            ...
            //public static Task<ObservableCollection<ConfiguracionProcedimientoOdontologiaEntity>> ConsultarProcedimientosConfigurados(short idIps)
            //{
            ...
            //public static Task<ObservableCollection<ConfiguracionProcedimientoOdontologiaEntity>> ConsultarProcedimientosConvenio()
            //{
            //    
            //    var tcs = new TaskCompletionSource<ObservableCollection<ConfiguracionProcedimientoOdontologiaEntity>>();
            ...
            public static Task<ObservableCollection<SesionesPlanTratamientoEntity>> ConsultarSesionesTratamiento(long IdTratamiento)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>> ConsultarProcedimientosConvenio(int idPaciente, short idConvenio, short idIps)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>>();
            ...
            public static Task<ObservableCollection<PlanTratamientoEntity>> ConsultarValoresProcedimiento(short IdIps, int idPaciente, PlanesTratamientoCollection Planes, bool gestante, short IdConvenio, short idEspecialidad)
            {
                inicializarContexto();
            ...
            public static Task<long> GuardarOdontogramaInicial(TratamientoEntity tratamiento, OdontogramasPacienteEntity odontogramaPaciente, List<OdontogramaEntity> odontograma, List<TratamientoImagenEntity> adjuntosImagen, short idIps)
            {
            ...
            public static Task<ObservableCollection<long>> GuardarPlanTratamiento(TratamientoEntity TratamientoEntity,
            ...
            public static Task<bool> GuardarImagenTratamiento(long idTratamientoPaciente, ObservableCollection<TratamientoImagenEntity> adjuntoImagenes)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<bool>();
            ...
            public static Task<ObservableCollection<ComprobanteEntity>> ListarComprobantes(short idIps, string usuario, short idSede)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<OdontogramaEntity>> ListarHistorial(long idTratamiento, short idIps)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<ObservableCollection<OdontogramaEntity>>();
            ...
            public static Task<ObservableCollection<TerceroEntity>> ListarHigienistasPorIps(short IdIps)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<TerceroEntity>> ListarOdontologosPorIps(short IdIps)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<ObservableCollection<TerceroEntity>>();
            ...
            public static Task<ObservableCollection<OdontogramaEntity>> ListarOdontogramaTratamiento(Int64 idOdontogramaPaciente, short idIps)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<ObservableCollection<OdontogramaEntity>>();
            ...
            public static Task<ObservableCollection<OdontogramasPacienteEntity>> ListarOdontogramasSinTratamiento(int IdPaciente, short IdIps)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<FinalidadProcedimientoEntity>> ListarFinalidadesProcedimiento(short idIps)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<PacienteConvenioEntity>> ListarConveniosPaciente(short idIps, int idPaciente)
            {
                inicializarContexto();
            ...
            public static Task<ObservableCollection<ParametroOdontologicoConvenioEntity>> ListarParametrosConvenio(short IdIps, short idConvenio)
            {
                inicializarContexto();
            ...
            public static Task<ParametroOdontologicoBodegaEntity> ListarParametrosBodega(short idIps)
            {
                inicializarContexto();
            ...
            public static Task<TratamientoEntity> SeleccionarTratamientoActivo(long idTratamiento)
            {
                inicializarContexto();
            ...
            public static Task<OdontogramasPacienteEntity> SelecionarOdontogramaPaciente(long idOdontogramaPaciente)
            {
                inicializarContexto();
            ...
            public static Task<long> ReciboCajaTratamiento(long idTratamiento)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<long>();
            ...
            public static Task<decimal> ValorPagoTratamiento(long idTratamiento)
            {
                inicializarContexto();
            ...
            public static Task<bool> ValidarusuarioCierraTratamiento(string idUsuario, string Clave)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<bool>();
            ...
            public static Task<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>> ConsultarProcedimientosConfigurados(short idIps)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>>();
            ...
            public static Task<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>> ConsultarDiagnosticosConfigurados(short idIps)
            {
                inicializarContexto();
                var tcs = new TaskCompletionSource<ObservableCollection<ConfigurarDiagnosticoProcedimOtraEntity>>();
