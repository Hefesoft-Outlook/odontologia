	...
	public partial class UserControlColorDienteCompleto : UserControl
	{
        ...
        protected virtual void OnItemChanged(DependencyPropertyChangedEventArgs e)
        {
            if (e.NewValue != null)
            {
                ...
                {
                    texto.Visibility = System.Windows.Visibility.Visible;
                ...
                else if (!string.IsNullOrEmpty(item.Letra))
                {
                    ...
                    texto.FontFamily = new System.Windows.Media.FontFamily("Portable User Interface");
                    texto.Visibility = System.Windows.Visibility.Visible;
                ...
                else
                {
                    if (item.Color != null)
                    {
                        texto.Visibility = System.Windows.Visibility.Collapsed;
