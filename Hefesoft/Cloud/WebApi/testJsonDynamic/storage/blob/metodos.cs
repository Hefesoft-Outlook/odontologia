...
namespace testJsonDynamic.storage
{
    public partial class blobStorage
    {
        ...
        private Uri UploadDocument(string partitionKey, string rowKey, string document, string nombreTabla)
        {
        ...
        private string DownloadDocument(dynamic entidad)
        {
        ...
        private void DeleteDocument(string partitionKey, string rowKey, string nombreTabla)
        {
